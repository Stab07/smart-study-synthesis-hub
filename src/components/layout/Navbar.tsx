        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <div className="hidden md:ml-10 md:flex md:space-x-8">
              <Link to="/" className="text-gray-500 dark:text-gray-300 hover:text-brand-500 dark:hover:text-brand-400 px-3 py-2 text-sm font-medium">
                Home
              </Link>
              <Link to="/upload" className="text-gray-500 dark:text-gray-300 hover:text-brand-500 dark:hover:text-brand-400 px-3 py-2 text-sm font-medium">
                Upload
              </Link>
              <Link to="/results" className="text-gray-500 dark:text-gray-300 hover:text-brand-500 dark:hover:text-brand-400 px-3 py-2 text-sm font-medium">
                Results
              </Link>
              <div className="relative group">
                <button className="text-gray-500 dark:text-gray-300 hover:text-brand-500 dark:hover:text-brand-400 px-3 py-2 text-sm font-medium flex items-center">
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="px-3 py-2">
              <p className="text-base font-medium text-gray-700">Features</p>
